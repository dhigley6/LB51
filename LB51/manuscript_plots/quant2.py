...
EFFICIENCY_TO_AMPLIFICATION = 0.01*0.1/1E-8/1E6    #see function at bottom (millions)
...
def quant2():
    ...
    _short_stim_plot(axs[0, 0], measured, sim_results_5fs, sim_results_5fs_enhanced)
