...
EFFICIENCY_TO_AMPLIFICATION = SPON_EFFICIENCY*ACCEPTANCE_ANGLE_FRACTION/1E6    # (millions)
...
def quant2():
    ...
    _format(f, axs)
    plt.savefig("manuscript_plots/2021_10_03_quant.eps", dpi=600)
    plt.savefig("manuscript_plots/2021_10_03_quant.png", dpi=600)
...
def _short_stim_plot(ax, measured, sim_results_5fs, sim_results_5fs_enhanced, f):
    ...
    l3, = ax.plot(
        ...
        np.array(sim_results_5fs_enhanced["stim_efficiencies"]) * EFFICIENCY_TO_AMPLIFICATION,
        color="tab:orange",
        label="Enhancement\nSimulation",
    )
    f.legend((l2, l3, l1), ('Three Level Simulation', 'Enhancement Simulation', 'Experiment'), 'upper center', ncol=2)
...
def _long_stim_plot(ax, measured, sim_results_25fs, sim_results_25fs_enhanced):
    ...
    ax.plot(
        ...
        np.array(sim_results_25fs_enhanced["stim_efficiencies"]) * EFFICIENCY_TO_AMPLIFICATION,
        color="tab:orange",
        label="Enhancement\nSimulation",
    )
