...
def get_cals(run):
    ...
    spec_ROIs = {'sam_spec_ROI': (csv_cals['sam_spec_ROI_top'], csv_cals['sam_spec_ROI_bot'], csv_cals['sam_spec_ROI_left'], csv_cals['sam_spec_ROI_right']),
                 'no_sam_spec_ROI': (csv_cals['no_sam_spec_ROI_top'], csv_cals['no_sam_spec_ROI_bot'], csv_cals['no_sam_spec_ROI_left'], csv_cals['no_sam_spec_ROI_right'])}
...
def get_good_runs_list():
    ...
    """
    all_runs = []
    all_runs.append({'all_runs': [17],
                     'good_sample_runs': [17],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': [20, 22, 23, 24, 25],
                     'good_sample_runs': [],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': [32],
                     'good_sample_runs': [32],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': [33],
                     'good_sample_runs': [33],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': [34],
                     'good_sample_runs': [34],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': [35],
                     'good_sample_runs': [35],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': [36],
                     'good_sample_runs': [36],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.arange(86, 97),
                     'good_sample_runs': np.arange(86, 97),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.arange(99, 121),
                     'good_sample_runs': np.arange(99, 120, 2),
                     'good_no_sample_runs': np.arange(100, 121, 2)})
    all_runs.append({'all_runs': np.append(np.arange(122, 125), np.arange(126, 133)),
                     'good_sample_runs': np.append(np.arange(122, 125), np.arange(126, 133)),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.append(np.arange(136, 147, 2), np.arange(149, 156, 2)),
                     'good_sample_runs': np.append(np.arange(136, 147), np.arange(149, 156)),
                     'good_no_sample_runs': np.append(np.arange(137, 148, 2), np.arange(150, 157, 2))})
    all_runs.append({'all_runs': np.arange(166, 175),
                     'good_sample_runs': np.arange(166, 175),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.arange(177, 198),
                     'good_sample_runs': np.append(177, np.arange(180, 197, 2)),
                     'good_no_sample_runs': np.append(np.arange(178, 180), np.arange(181, 198, 2))})
    all_runs.append({'all_runs': [198],
                     'good_sample_runs': [198],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.arange(211, 287),
                     'good_sample_runs': np.arange(211, 260),
                     'good_no_sample_runs': [287]})
    # Need to fix starting here
    all_runs.append({'all_runs': np.append(np.arange(290, 307), np.arange(312, 319)),
                     'good_sample_runs': np.append(np.arange(290, 307), np.arange(312, 319)),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.arange(331, 357),
                     'good_sample_runs': np.arange(331, 357),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.arange(359, 385),
                     'good_sample_runs': np.arange(359, 385),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.append([388], np.arange(390, 415)),
                     'good_sample_runs': np.append([388], np.arange(390, 415)),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.arange(416, 428),
                     'good_sample_runs': np.arange(416, 428),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.arange(438, 443),
                     'good_sample_runs': np.arange(438, 443),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.append(np.arange(454, 464), np.arange(465, 473)),
                     'good_sample_runs': np.append(np.arange(454, 464), np.arange(465, 473)),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': [477],
                     'good_sample_runs': [477],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.append(np.arange(481, 493), np.arange(494, 500)),
                     'good_sample_runs': np.append(np.arange(481, 493), np.arange(494, 500)),
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': [503, 504],
                     'good_sample_runs': [503, 504],
                     'good_no_sample_runs': []})
    all_runs.append({'all_runs': np.append(np.arange(510, 516), np.arange(523, 536)),
                     'good_sample_runs': np.append(np.arange(510, 516), np.arange(523, 536)),
                     'good_no_sample_runs': []})
    # all runs seem ok in 548-551
    all_runs.append({'all_runs': np.arange(548, 552),
    ...
    all_runs.append({'all_runs': np.arange(596, 602),
    ...
    all_runs.append({'all_runs': np.append(np.arange(603, 639), np.arange(647, 671)),
    ...
    all_runs.append({'all_runs': np.arange(641, 644),
                     'good_sample_runs': [641, 643],
                     'good_no_sample_runs': []})
    # Note: 669 has basically zero sample spectra, 668 has very low
    all_runs.append({'all_runs': np.arange(647, 671),
